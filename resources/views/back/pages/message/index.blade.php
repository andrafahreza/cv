                        ...
                        <div class="iq-email-ui nav flex-column nav-pills">
                            <li class="nav-link active" role="tab" data-toggle="pill" href="#mail-inbox">
                                <a href="#">
                                    ...
                                    @if ($datas->where('status', false)->count() > 0)
                                        <span class="badge badge-primary ml-2">{{ $datas->where('status', false)->count() }}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="nav-link" role="tab" data-toggle="pill" href="#mail-starred">
                                <a href="#">
                                    ...
                                    @if ($stars->where('status', false)->count() > 0)
                                        <span class="badge badge-primary ml-2">{{ $stars->where('status', false)->count() }}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="nav-link" role="tab" data-toggle="pill" href="#mail-trash">
                                <a href="#">
                                    ...
                                    @if ($trash->where('status', false)->count() > 0)
                                        <span class="badge badge-primary ml-2">{{ $trash->where('status', false)->count() }}</span>
                                    @endif
                                </a>
                            </li>
                        </div>
